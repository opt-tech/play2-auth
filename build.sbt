...
lazy val sample = Project("sample", file("sample"))
  ...
  .settings(
    ...
    libraryDependencies += "org.scalikejdbc"      %% "scalikejdbc-test"                  % "2.5.2"   % "test",
    libraryDependencies += "org.scalikejdbc"      %% "scalikejdbc-play-initializer"      % "2.5.3",
    libraryDependencies += "org.scalikejdbc"      %% "scalikejdbc-play-dbapi-adapter"    % "2.5.3",
    libraryDependencies += "org.scalikejdbc"      %% "scalikejdbc-play-fixture"          % "2.5.3",
...
lazy val socialSample = Project("social-sample", file("social-sample"))
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.scalikejdbc"   %% "scalikejdbc-play-fixture"          % "2.5.3"
    ),
    publish           := { },
    publishArtifact   := false,
    packagedArtifacts := Map.empty,
